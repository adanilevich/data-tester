...
from src.dtos import (
    TestObjectDTO, DomainConfigDTO, SpecificationDTO, TestType, TestCaseDefinitionDTO
)
...
class TestCaseFactory:
    ...
    def create(
        ...
        if definition.testtype not in cls.known_testtypes:
            msg = f"Test '{definition.testtype}' unknown! Known : {cls.known_testtypes}"
            raise TestCaseUnknownError(msg)
        else:
            testcase = cls.known_testtypes[definition.testtype](
