...
class TestDummyTestcases:
    ...
    def test_ok_testcase(self, testcase_creator):
        testcase: TestCase = testcase_creator(ttype="DUMMY_OK")
        testcase.execute()
    ...
    def test_nok_testcase(self, testcase_creator):
        testcase: TestCase = testcase_creator(ttype="DUMMY_NOK")
        testcase.execute()
    ...
    def test_exception_testcase(self, testcase_creator):
        testcase: TestCase = testcase_creator(ttype="DUMMY_EXCEPTION")
        testcase.execute()
