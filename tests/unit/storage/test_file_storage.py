...
from src.storage.file_storage import FileStorage, ObjectNotFoundError
...
class TestFileStorage:
    """Test FileStorage implementation with new interface"""
    ...
    def test_read_nonexistent_object(self, storage: FileStorage):
    ...
    def test_write_read_bytes_roundtrip(self, storage: FileStorage):
        """Test writing and reading raw bytes"""
        content = b"test content"
        location = LocationDTO("memory://test/file.txt")
    ...
    def test_list_objects(self, storage: FileStorage):
        """Test listing objects of a specific type"""
        location = LocationDTO("memory://testlist")
        subfolder_location = LocationDTO("memory://testlist/subfolder")
    ...
    def test_list_files(self, storage: FileStorage):
        """Test listing files using list_files method"""
        location = LocationDTO("memory://testfiles")
        subfolder_location = LocationDTO("memory://testfiles/subfolder")
